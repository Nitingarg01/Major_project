                ...
                <DialogHeader>
                    ...
                    <div className='flex flex-col gap-5'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex flex-col text-sm gap-2 bg-gray-100 p-1'>
                                
                                <span className='flex flex-row gap-1'><span className='flex flex-row gap-2'><Badge variant='default'>Submit</Badge><ArrowLeft size={20}/></span>Press Submit only after you have attempted all questions.</span>
