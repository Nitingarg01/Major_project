...
const InterviewCard = async ({interview}:InterviewCardProps) => {
  ...
  return (
    <div className='border-2 border-black rounded-xl bg-gray-50 m-4 p-2 flex flex-row gap-4 w-[25vw] h-[50px]'>
      <div className='w-[65px] h-[65px] rounded-full overflow-hidden flex flex-col items-center'>
