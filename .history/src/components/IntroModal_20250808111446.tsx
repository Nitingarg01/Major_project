                    ...
                    <div className='flex flex-col gap-5'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex flex-col text-sm'>
                                <span className='flex flex-row'><Badge variant='default'>Submit</Badge><ArrowLeft size={20}/></span>
                                <span>Press Submit only after you have attempted all questions.</span>
