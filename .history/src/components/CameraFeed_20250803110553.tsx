...
const CameraFeed = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2 w-full">
      ...
      <div className="mt-3 w-full min-h-[80px] border border-gray-400 p-2 text-sm rounded overflow-y-auto">
      ...
      <div className='w-full mt-2 flex flex-row justify-center items-center '>
        <Textarea className='h-[12vh]' placeholder='Your answer here!' value={transcript} onChange={()=>setTranscript}/>
      </div>
    </div>
  );
};
