        ...
        <div className='flex flex-col gap-1'>
          ...
          <div className='flex flex-row justify-center'>
            <div className='border-2 bg-gray-50 rounded-lg w-[80%] flex flex-col items-center p-2' >
              ...
              {det?.length>0 ? <InterviewWrapper questions={det?.questions} id={id}/> : <span className='text-2xl font-semibold'>Interview Not Ready Please Visit After Few Minutes</span>}
