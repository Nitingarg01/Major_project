...
import { createInterview, parsingResume, uploadToCloudinary } from "./actions"
...
const Createform = () => {
    ...
    const parseResume = async (file: File) => {
       ...
       await parsingResume(formData)

        //UPLOADING IT TO CLOUD
        ...
        setProjectContext(prev => [...prev, ...projectCont]);
        setWorkExDetails(prev=>[...prev,...workExDets])
