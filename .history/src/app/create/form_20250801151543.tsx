...
const schema = z.object({
    ...
    skills: z.array(z.string().min(1, "Enter Valid Skill")).min(5, "Enter at least 5 Skills").max(20, "Enter at max 10 skills"),
...
const Createform = () => {
    ...
    const onSubmit = async (data: z.infer<typeof schema>) => {
        ...
        // console.log(projectContext,workExDetails)
        try {
            await createInterview(data,projectContext,workExDetails)
    ...
    const parseResume = async (file: File) => {
        ...
        const {skills,projects,wokex} = data
        console.log(skills,projects,wokex)
    ...
    <div className="text-xs"><span>Upload only .pdf,.doc,.docx</span></div>
                                    </div>
                                </div>
                                <Input
                                    id="resume-upload"
                ...
                <div className="flex justify-center">
                     <Button variant="default" type="submit" className="w-[30%]">
